        ...
        <div class="col-xs-12 col-sm-12"  style="min-height: 540px;">
          <div class="panel panel-primary">
             <div class="panel-heading"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>&nbsp;关于/日志</div>
              ...
              <ul class="dropdown-menu">
                <?php if(is_array($logs)): $i = 0; $__LIST__ = $logs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><li><a href="/thinkphp/index.php/Home/Index/editlog?time=<?php echo ($log["time"]); ?>"><?php echo (date('Y-m-d',$log["time"])); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
