...
<div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="row featurette">
                ...
                <div class="col-md-5">
                  <img class="featurette-image img-responsive center-block" src="/thinkweb/Public/home/imgs/jian.png" alt="Generic placeholder image">
                </div>
        </div>
        <hr>
        <div class="row featurette">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar1">
          ...
          <?php $__FOR_START_8379__=2016;$__FOR_END_8379__=2008;for($i=$__FOR_START_8379__;$i > $__FOR_END_8379__;$i+=-1){ ?><a href="#" class="list-group-item"><?php echo ($i); ?>  <span class="badge">4</span></a><?php } ?>
          </div>
