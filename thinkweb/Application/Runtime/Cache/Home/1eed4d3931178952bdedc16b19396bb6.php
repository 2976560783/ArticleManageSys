...
<ol class="breadcrumb">
  ...
  <?php if($category): ?><li><a href="#"><?php echo ($category); ?></a></li><?php endif; ?>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar1">
          ...
          <?php $__FOR_START_6990__=2016;$__FOR_END_6990__=2008;for($i=$__FOR_START_6990__;$i > $__FOR_END_6990__;$i+=-1){ ?><a href="#" class="list-group-item"><?php echo ($i); ?>  <span class="badge">4</span></a><?php } ?>
          </div>
