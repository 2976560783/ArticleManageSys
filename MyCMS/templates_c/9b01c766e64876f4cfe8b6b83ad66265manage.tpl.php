...
<form action="manage.php?action=update" method="post" accept-charset="utf-8">
    ...
    <table class="add_update">
        ...
        <tbody>
            <tr>
                <th>用 &nbsp;户 &nbsp;名:</th>
                <td><input type="text" name="admin_name" maxlength="10" class="text" value="<?php echo $this->var['admin_name']; ?>" readonly="readonly" placeholder="*设置2至10位用户名*" ></td>
            </tr>
            <tr>  
                 <th>新 密&nbsp;&nbsp;码:</th>
            ...
            <tr>     
                <td colspan="2"><input type="submit" class="submit" name="updateManager" onclick="pass_check()" value="确认修改">&nbsp;&nbsp;[<a href=<?php echo $this->var['prev_url']; ?>>返回列表</a>]</td>
            </tr>
        </tbody>
    </table>
