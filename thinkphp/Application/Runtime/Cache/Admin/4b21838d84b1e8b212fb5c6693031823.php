...
<div id="showMovie">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$vlist): ?><tr>
                ...
                <td><a href="/thinkphp/index.php/video/editVideo?id=<?php echo ($vlist["id"]); ?>" title="编辑">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="/thinkphp/index.php/video/deleteVideo?id=<?php echo ($vlist["id"]); ?>" onclick="return confirm('确认要删除本条记录!');" title="删除">删除</a>
                </td>
    ...
    <?php echo ($page); ?>
    <label>分类显示:</label>
    <span><a href="/thinkphp/index.php/video/showVideo" title="全部">全部</a></span>
    <span><a href="/thinkphp/index.php/video/showVideo?class=电影" title="电影">电影</a></span>
    <span><a href="/thinkphp/index.php/video/showVideo?class=动漫" title="动漫">动漫</a></span>
    <span><a href="/thinkphp/index.php/video/showVideo?class=番剧" title="番剧">番剧</a></span>
    <br>
    <span><a href="/thinkphp/index.php/video/addVideo" title="主界面" style="color: blue;">新增视频</a></span>
    &nbsp;&nbsp;&nbsp;&nbsp;
