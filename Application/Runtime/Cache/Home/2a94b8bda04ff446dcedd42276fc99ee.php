...
<div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-3 col-sm-3 sidebar-offcanvas" id="sidebar1">
          ...
          <?php $__FOR_START_2015168688__=2016;$__FOR_END_2015168688__=2008;for($i=$__FOR_START_2015168688__;$i > $__FOR_END_2015168688__;$i+=-1){ ?><a href="#" class="list-group-item"><?php echo ($i); ?>  <span class="badge">4</span></a><?php } ?>
          </div>
