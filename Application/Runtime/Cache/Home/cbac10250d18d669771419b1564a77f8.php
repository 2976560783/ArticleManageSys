...
<link rel="stylesheet" href="/Public/home/css/simditor-markdown.css" media="screen" charset="utf-8" />
<link rel="stylesheet" type="text/css" href="/Public/home/css/simditor.css" />
<link rel="stylesheet" type="text/css" href="/Public/home/css/simditor-fullscreen.css" />
      ...
      <div class="container">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              ...
              <li><a href="/Home/article/add" title="">发布文章</a></li>
              <li><a href="/Home/article/mine" title="">我的文章</a></li>
        ...
        <form action="#" method="post" accept-charset="utf-8">
            ...
            <div class="btn-group" data-toggle="buttons">
              <label class="btn btn-default btn-sm active tags">
                <input type="radio" name="tag" value="1" autocomplete="on" checked> 未分类
              </label>
...
<script src="/Public/home/js/offcanvas.js"></script>
  ...
  <script type="text/javascript" src="/Public/home/js/module.js"></script>
  <script type="text/javascript" src="/Public/home/js/hotkeys.js"></script>
  <script type="text/javascript" src="/Public/home/js/uploader.js"></script>
  <script type="text/javascript" src="/Public/home/js/marked.js"></script>
  <script type="text/javascript" src="/Public/home/js/simditor.js"></script>
  <script type="text/javascript" src="/Public/home/js/to-markdown.js"></script>
  <script type="text/javascript" src="/Public/home/js/simditor-markdown.js"></script>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      if (<?php echo ($ainfo["tagid"]); ?>) {
        $("[type='radio']").each(function(){
          if ($(this).val() == <?php echo ($ainfo["tagid"]); ?>) {
