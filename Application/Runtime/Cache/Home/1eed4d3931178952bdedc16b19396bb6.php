  ...
  <?php if($category): ?><li><a href="#"><?php echo ($category); ?></a></li><?php endif; ?>
        ...
        <div class="col-xs-3 col-sm-3 sidebar-offcanvas" id="sidebar1">
          <div class="list-group">
            ...
            <a href="/Home/article" class="list-group-item">全部<span class="badge"><?php echo ($count); ?></span></a>
            <br>
          ...
          <?php $__FOR_START_1937319779__=2016;$__FOR_END_1937319779__=2008;for($i=$__FOR_START_1937319779__;$i > $__FOR_END_1937319779__;$i+=-1){ ?><a href="#" class="list-group-item"><?php echo ($i); ?>  <span class="badge">4</span></a><?php } ?>
          </div>
