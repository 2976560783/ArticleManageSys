...
<!--   <input type="hidden" name="uid" id="uid" value="<?php echo ($details["uid"]); ?>"> -->
  <input type="hidden" name="aid" id="aid" value="<?php echo ($details["aid"]); ?>">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <?php if(isset($prev)): ?><a href="/Home/Article/details?artid=<?php echo ($prev); ?>" title="">
          ...
          <?php if(isset($next)): ?><a href="/Home/Article/details?artid=<?php echo ($next); ?>" title="">
  ...
  <script>
    $(document).ready(function() {
      ...
      act.removeClass('active');
       $.post('/Home/Article/like', {aid:<?php echo ($details["aid"]); ?>,check:'c'}, function(data, textStatus, xhr) {
      ...
      $('#like').click(function() {
         $.post('/Home/Article/like', {aid:<?php echo ($details["aid"]); ?>}, function(data, textStatus, xhr) {
           if (textStatus == 'success') {
              if (data == '0') {
                 $('#like').css('color','red');
                  $('#like').text('已赞');
