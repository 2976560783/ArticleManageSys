    ...
    <div class="panel panel-default">
        <table class="table table-bordered table-hover">
            <tbody>
                ...
                <tr>
                    <td>生日</td>
                    <td><?php echo (date("Y-m-d",$baseInfo["birthday"])); ?></td>
                </tr>
                <tr>
                    <td>性别</td>
                    <td>
    ...
    <div class="panel panel-default">
      ...
      <form id="setInfo" action="setUserInfo" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td colspan="" rowspan="" headers=""><input type="date" class="form-control" name="birthday" value="<?php echo (date("Y-m-d",$setInfo["birthday"])); ?>" placeholder=""></td>
        </tr>
        <tr>
