...
<ol class="breadcrumb">
  ...
  <li class="active">详细</li>
        ...
        <div class="col-xs-12 col-sm-9">
          <div class="jumbotron">
            <h1>你都不懂得拒绝，又哪来真正的朋友</h1>
            <label for=""><span class="glyphicon glyphicon-user" aria-hidden="true">作者:付立</span></label>&nbsp;&nbsp;
            <label for=""><span class="glyphicon glyphicon-time" aria-hidden="true">发布时间:2016-04-22 </span></label>&nbsp;&nbsp;
            <label for=""><span class="glyphicon glyphicon-tag" aria-hidden="true">标签:修仙 </span></label>&nbsp;&nbsp;
            <label for=""><span class="glyphicon glyphicon-eye-open" aria-hidden="true">阅读量:30 </span></label>
            <h2 style="text-indent:2em;"><small >关于做读书笔记，每个人都会有自己的方法，我在这里所分享的方法，说不上最好，但却是我在漫长的阅读生涯中所总结出来的，我们希望，你也能向我们分享一下你在阅读和做读书笔记中的经验。</small></h2>
            <p style="text-indent: 2em;">我做读书笔记主要分为以下几个步骤：

<br>
              <b>2. 汇总
笔记的汇总，也需要分纸质书和电子书两个渠道。</b>
纸书笔记汇总

这个比较麻烦，没有完美的解决方案，而我是这样做的：

一般情况下，将书中所勾画内容的重要部分进行拍照；
十分重要的书，会将勾画内容手打出来。
电子书笔记汇总

电子书就简单多了，就我阅读的主力工具Kindle而言，每一次在书中进行勾画的内容，都会记录在Kindle的“我的剪贴”文档中，将Kindle设备连接到电脑上，在“Documents”文件夹中，有一个名为“My Clippings.txt”的文本文档，这个文档就是“我的剪贴”的所有内容。


20160420_4
将文档拷贝到电脑中，使用一款名为“KindleMate”的软件打开，即可看到所有勾画的内容文本，并以包含勾画的书名进行分类，如下图：
...
所有的读书笔记，我都会保存到印象笔记——或者其他的笔记软件，可参考之前的两篇文章《化零为整的高效——你需要一款笔记应用》和《你早该这样记笔记——高效的印象笔记调教术》。

保存笔记时，笔记标题以名书命名，并打上相应的标签，我的读书笔记如下图：
...
结语
愿大家能够更好的阅读，更科学的做读书笔记，更慷慨的分享。

文／PomoNote（简书作者）
原文链接：http://www.jianshu.com/p/21d43b0302b8
著作权归作者所有，转载请联系作者获得授权，并标注“简书作者”。</p>
      ...
      <button type="button" class="btn btn-info" style="float: right;">下一篇 &nbsp;
