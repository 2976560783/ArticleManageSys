        ...
        <thead>
            ...
            <tbody>
                <?php if(is_array($myarts)): $key = 0; $__LIST__ = $myarts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$myart): $mod = ($key % 2 );++$key;?><tr>
                    ...
                    <td><a type="button" class="btn btn-warning  btn-xs" href="/Home/Article/edit?aid=<?php echo ($myart["aid"]); ?>">编辑</a>&nbsp;&nbsp;
                        <a type="button" class="btn btn-danger  btn-xs" href="/Home/Article/delete?aid=<?php echo ($myart["aid"]); ?>" onclick="javescript:return confirm('确认删除这篇文章?')">删除</a>
                    </td>
